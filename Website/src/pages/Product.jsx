    ...
    <div className="container">
        <div className="card-img">
            ...
            <Carousel
              ...
              fade
              style={{
                display: 'flex', width: 'auto', height: 'auto', padding: 'auto', margin: 'auto', position: 'relative',
              }}
            >
                {picture?.map((pict) => (
                    // eslint-disable-next-line import/no-dynamic-require, global-require
                    <Carousel.Item>
                        <img key={pict.id} className="imagen" src={require(`../../../API/uploads/${pict.filename}`)} alt={pict.originalname} />
                    </Carousel.Item>
                ))}
            </Carousel>
        </div>
